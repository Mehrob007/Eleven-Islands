...
export default function PlacingAnOrder() {
  ...
  const validate = () => {
    ...
    if (
      ...
      formState.phoneNumber.replace(/[^\d]/g, "")?.length !== 11
    )
    ...
    scrollToSection(
      (newErrors.name && "name") ||
        ...
        (newErrors.phoneNumber && "phoneNumber") ||
      ...
      <div className="PlacingAnOrder__box">
        ...
        >
          ...
          <div className="PlacingAnOrder__form__1">
            ...
            <div className="PlacingAnOrder__form__div__1">
              <div className="PlacingAnOrder__form__1">
                <div className="PlacingAnOrder__form__div__3">
                  <div
                    onClick={() =>
                      onChange("deliveryType", DELIVERY_TYPES.DOOR_TO_DOOR)
                    }
                  >
                  ...
                  <div
                    onClick={() =>
                      onChange("deliveryType", DELIVERY_TYPES.PICKUP_POINT)
                    }
                  >
                    <div className="PlacingAnOrder__CheckTrue">
                      {!isDoorToDoorDelivery ? (
            ...
            <div className="PlacingAnOrder__form__div__1">
              <RadioGroup
                currentValue={formState.deliveryService}
                radios={[
                  {
            ...
            <div className="PlacingAnOrder__form__div__1">
              <div className="PlacingAnOrder__form__div__4">
                {formState.deliveryType === DELIVERY_TYPES.PICKUP_POINT ? (
                  {
                    [DELIVERY_SERVICES.YANDEX_DELIVERY]: (
                      <YandexDeliveryMap
                        city={formState.city}
            ...
            <div className="PlacingAnOrder__form__div__3">
              <div>
                <div
                  ...
                  onClick={() =>
                    onChange(
                      "isAgreedWithPolicies",
                      !formState.isAgreedWithPolicies,
                    )
                  }
                >
                  {formState.isAgreedWithPolicies ? (
          ...
          <div className="PlacingAnOrder__form__price">
            ...
            <div className="PlacingAnOrder__form__raschot">
              ...
              <button
                disabled={!formState.isAgreedWithPolicies || loading}
                className={`button__placing__an__order ${
                  !formState.isAgreedWithPolicies && "block__button"
                }`}
                type="submit"
              >
                Оформить заказ
